                       ...
                       data.contents.tileMatrixSets[layer.tileMatrixSetLinks[j].tileMatrixSet].matrixIds.length>0){
                         ...
                         var config = {
                          ...
                          for (var curFormat=0, formatCount=layer.formats.length; curFormat<formatCount; curFormat++) {
                             ...
                             console.log(layer.bound);
                             /*layer.addOptions({
                               maxExtent: OpenLayers.Bounds.fromArray([-122.911,42.291,-122.787,42.398]),
                             })*/
                             console.log("layers");
                             console.log(layer);
                             records.push(new this.recordType({
                                 /*layer: new OpenLayers.Layer.WMTS(config),*/
                                 layer: this.meta.format.createLayer( this.raw, {matrixSet: config.matrixSet, layer: layer.identifier}),
                                 title: layer.title,
                                 source: null,
